// frontend/src/pages/CryptoSelectionPage.jsx (NUEVO ARCHIVO - FLEXIBLE)
...
const CryptoSelectionPage = () => {
  ...
  // Se adapta a ambos flujos: si viene `tool`, es una compra. Si no, es una recarga.
  ...
  const isPurchaseFlow = !!tool; // True si `tool` existe
