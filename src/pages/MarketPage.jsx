            ...
            <div className="p-4">
                <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        {/* Se reemplaza CryptoIcon por una etiqueta <img> estándar. */}
                        {/* La fuente (src) es la imageUrl que viene directamente del item. */}
                        <img 
                            src={item.imageUrl} 
                            alt={item.name} 
...
// --- COMPONENTE DE PÁGINA PRINCIPAL (Lógica sin cambios) ---
const MarketPage = () => {
