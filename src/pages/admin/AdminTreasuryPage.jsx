// RUTA: frontend/src/pages/admin/AdminTreasuryPage.jsx (VERSIÓN "NEXUS - DYNAMIC USDT SWEEP")
...
const AdminTreasuryPage = () => {
    ...
    // [NEXUS] Estado para la dirección de destino dinámica del barrido USDT.
    ...
    const handleOpenUsdtSweepModal = () => {
        ...
        setRecipientAddress(''); // [NEXUS] Reseteamos la dirección al abrir el modal.
        setIsSweepModalOpen(true);
    };

    const handleSweepConfirm = async () => {
        // [NEXUS] Validación de la dirección de destino antes de enviar.
        if (!recipientAddress || !/^0x[a-fA-F0-9]{40}$/.test(recipientAddress)) {
            return toast.error('Por favor, introduzca una dirección de destino válida (formato 0x...).');
        }

        setIsSweepModalOpen(false);
        // [NEXUS] Se añade `recipientAddress` al payload.
        const payload = { 
    ...
    const handleSweepGas = async () => {
        ...
        // [NEXUS] El payload para barrido de gas NO necesita dirección. El backend usa la de .env.
    ...
    return (
        <>
            ...
            {/* [NEXUS] Se pasan las props necesarias al modal para manejar la dirección de destino. */}
