// frontend/src/pages/admin/AdminWithdrawalsPage.jsx (COMPLETO)
...
const AdminWithdrawalsPage = () => {
  ...
  const handleProcessWithdrawal = async (txId, newStatus) => {
    ...
    if (newStatus === 'rejected') {
      ...
      if (notes === null) return; // El usuario canceló el prompt
    } else {
    ...
    try {
      await api.put(`/admin/withdrawals/${txId}`, { newStatus, adminNotes: notes });
      toast.success(`Retiro procesado como "${newStatus}".`);
      // Refrescar la lista para eliminar el retiro procesado
